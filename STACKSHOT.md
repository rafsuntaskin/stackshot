...
After the user chooses a style, output only this block with all placeholders replaced:

```text
Generate a 1200x630 pixel tech stack card image in [STYLE_TYPE] style.
...
- Stats row: 4 equal columns (FILES / LOC / LANGUAGES / TESTS) with values prominent and labels small below
